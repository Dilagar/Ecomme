...
$res = mysqli_query($conn, "SELECT o.*, u.email, a.full_name, a.line1, a.city, a.postal_code, a.country FROM orders o JOIN users u ON u.id=o.user_id JOIN addresses a ON a.id=o.address_id WHERE o.id=$id LIMIT 1");
...
<div class="container">
    ...
    <div class="card">
        ...
        <div><strong>Billed To:</strong> <?php echo e($order['full_name']); ?>, <?php echo e($order['line1']); ?>, <?php echo e($order['city']); ?>, <?php echo e($order['postal_code']); ?>, <?php echo e($order['country']); ?></div>
